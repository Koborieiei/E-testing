...
!(function (e, t) {
 ...
 var h = (function (n) {
  ...
  (se.uniqueSort = function (e) {
   var t,
    ...
    i = 0
   if (
    ((l = !d.detectDuplicates), (u = !d.sortStable && e.slice(0)), e.sort(D), l)
   ) {
    ...
    lang: le(function (n) {
     return (
      ...
      function (e) {
       ...
       do {
        if (
         (t = E ? e.lang : e.getAttribute('xml:lang') || e.getAttribute('lang'))
        )
 ...
 function le(e, t, n, r) {
  var i,
   ...
   c =
    e.nodeType && (k.cssNumber[t] || ('px' !== l && +u)) && ne.exec(k.css(e, t))
  if (c && c[3] !== l) {
   ;(u /= 2), (l = l || c[3]), (c = +u || 1)
   while (a--)
    k.style(e, t, c + l),
 ...
 function dt(o, e, t) {
  ...
  for (
   ...
   if ((n = dt.prefilters[r].call(l, o, c, l.opts)))
    return (
     m(n.stop) && (k._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n
    )
  return (
   k.map(c, pt, l),
