...
export default class Testingitem {
 ...
 _getCurrentUserLogJson() {
  const thisAnswerObject =
   this._getAnswerCatagory().answers[this._getIndexOfAnswer()]
 ...
 _updateAnswerCounter() {
  ...
  const totalQuestionNumber =
   this._getTotalNumberOfQuestionElement().textContent
