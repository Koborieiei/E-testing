  ...
  $.fn.smkValidate = function() {
    ...
    if (languaje === undefined) {
      ...
      languaje =  {
        ...
        textSPassExtra   : 'Minimum 8 characters Ex. Pass$1234',
      ...
      if (value !== '') {
        ...
        if (type === 'password') {
          ...
          switch (smkStrongPass) {
            ...
            break;
            case ('extra'):// Debe contener al menos 6 caracteres, un numero y una mayúscula
            strongPassRegex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/;
            textPass = languaje.textSPassExtra;
            break;
            default:// Debe contener al menos 4 caracteres
            strongPassRegex = null;
            textPass = languaje.textSPassDefault;
          }
          // Se valida que el value del input cumpla con la expresión regular
          if(strongPassRegex != null){
